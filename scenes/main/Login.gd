...
func _ready() -> void:
	...
	print("[Login] Scene path: ", get_path())
	print("[Login] CenterContainer valid: ", is_instance_valid(get_node_or_null("CenterContainer")))
	print("[Login] LoginPanel valid: ", is_instance_valid(get_node_or_null("CenterContainer/LoginPanel")))
