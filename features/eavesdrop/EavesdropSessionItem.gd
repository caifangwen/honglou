...
const EavesdropManagerRef = preload("res://features/eavesdrop/EavesdropManager.gd")
...
func setup(data: Dictionary):
	...
	var scene_name = EavesdropManagerRef.SCENE_CONFIGS.get(scene_key, {}).get("name", scene_key)
