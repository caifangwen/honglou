...
-- 添加精力系统相关表和函数
-- 日期：2026-03-17
-- 参考：8758979ac28bbf6b919b7252fb88fdc55a395667
-- ============================================================

-- 1. 添加 players 表的精力刷新时间字段
ALTER TABLE public.players 
ADD COLUMN IF NOT EXISTS stamina_refreshed_at timestamptz DEFAULT now();
